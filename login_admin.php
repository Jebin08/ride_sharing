...
if(isset($btn))
	{
		$q1=mysqli_query($connect,"select * from rs_admin where username='$username' && password='$password' ");
                        ...
                        <form name="form1" method="post">
							...
							<div class="row">
                                <div class="col-6 form-group">
                                    ...
                                    <input type="text" name="username" class="form-control p-4" placeholder="" required>
                                </div>
                                <div class="col-6 form-group">
									<label>Password</label>
                                    <input type="password" name="password" class="form-control p-4" placeholder="" required>
                                </div>
                            </div>
