...
if (isset($btn)) {
    $q1 = mysqli_prepare($connect, "SELECT * FROM rs_driver WHERE email=? AND uname=?");
    ...
    if ($n1 == 0) {
        $mq = mysqli_query($connect, "SELECT MAX(id) FROM rs_driver");
        ...
        $columns = array('id', 'name', 'gender', 'dob', 'address', 'city', 'pincode', 'mobile', 'email', 'aadhar', 'photo', 'uname', 'pass', 'create_date', 'status', 'driving', 'vehicle', 'vmodel', 'vno', 'vphoto', 'vehicle_st', 'trip_st');
        $values = array($id, $name, $gender, $dob, $address, $city, $pincode, $mobile, $email, $aadhar, $file, $uname, $pass, $rdate, 0, '', '', '', '', '', 0, 0);

        $placeholders = array();
        $bindingString = 'isssssssssssssssssssss';
        ...
        $sql = "INSERT INTO rs_driver ($columnsString) VALUES ($placeholdersString)";

        $ins = mysqli_prepare($connect, $sql);

        $bindParams = array();
        $bindParams[] = &$ins;
        $bindParams[] = $bindingString;
        ...
        if ($ins) {
            ...
            echo '<script>
    setTimeout(function() {
        window.location.href = "reg_driver2.php?rid=' . $id . '";
    }, 5000);
</script>';
        } else {
                        ...
                        <form name="form1" method="post" enctype="multipart/form-data" onsubmit="return validate();">
							...
							<div class="row">
                                <div class="col-6 form-group">
                                    ...
                                    <input type="date" name="dob" class="form-control p-4" maxlength="10">
                                </div>
                                <div class="col-6 form-group">
									<label>Address</label>
                                    <input type="text" name="address" class="form-control p-4" placeholder="">
                                </div>
                            </div>
							<div class="row">
                                <div class="col-6 form-group">
                                ...
                                <div class="col-6 form-group">
									<label>Pincode</label>
                                    <input type="text" name="pincode" class="form-control p-4" placeholder="">
                                </div>
                            </div>
							<div class="row">
                                <div class="col-6 form-group">
									<label>Mobile No.</label>
                                    <input type="text" name="mobile" class="form-control p-4" maxlength="10">
                                </div>
                                <div class="col-6 form-group">
									<label>Email</label>
							...
							<div class="row">
                                <div class="col-6 form-group">
                                    ...
                                    <input type="text" name="aadhar" class="form-control p-4" maxlength="12" placeholder="">
                                </div>
                                 <div class="col-6 form-group">
